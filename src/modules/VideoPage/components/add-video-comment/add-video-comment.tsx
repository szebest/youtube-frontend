		...
		<div className={styles.container}>
			...
			<Form className={styles.container__form} onSubmit={handleSubmit(submit)}>
				...
				<div className={styles.container__form__buttons}>
					{!((!isValid || isLoading || loadingComments) && id === undefined) && <button type="button" className="btn btn-secondary btn-md" onClick={handleCancel}>Cancel</button>}
					<button type="submit" disabled={!isValid || isLoading || loadingComments} className="btn btn-primary btn-md">
